<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="true" EnableEventValidation="false" CodeBehind="AdminLogin.aspx.cs" Inherits="WebMediaPortfolioTemplate.AdminLogin" %>
...
<head>
    ...
    <style type="text/css">
        .container-login100::before {
            ...
            left: 0;
            background: #005bea;
            background: -webkit-linear-gradient(bottom, #060708, #4a4a4a);
            background: -o-linear-gradient(bottom, #060708, #4a4a4a);
            background: -moz-linear-gradient(bottom, #060708, #4a4a4a);
            background: linear-gradient(bottom, #060708, #4a4a4a);
            opacity: 0.9;
        }
    </style>
    <!-- Styles End -->
                ...
                <form runat="server" class="login100-form validate-form">
                    <asp:Login ID="Login1" OnAuthenticate="ValidateUser" runat="server" EnableViewState="false" RenderOuterTable="false">
                        <LayoutTemplate>
                            ...
                            <span class="login100-form-title p-t-10 p-b-15">WebMediaPortfolioTemplate  Admin Login
                            </span>
