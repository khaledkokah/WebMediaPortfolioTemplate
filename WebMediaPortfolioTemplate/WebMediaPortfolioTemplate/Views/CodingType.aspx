<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CodingType.aspx.cs" Inherits="WebMediaPortfolioTemplate.Views.CodingType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp_pageTitle" runat="server">
    ...
    <script src="../App_JS/Setup/codingType.js"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cp_content" runat="server">
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <!-- start list -->
            <asp:GridView ShowHeaderWhenEmpty="true" class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateDeleteButton="false" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="false">
                <Columns>
                    <asp:BoundField Visible="false" DataField="CodingType_Id" HeaderText="CodingType Id" />
                    <asp:TemplateField HeaderText="Description" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <a href='#' onclick="showModal('<%# Eval("CodingType_ID").ToString() %>',false)"><%# Eval("Description")%></a> </td>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:LinkButton OnClientClick='if (!confirm("Are you sure you want to delete this record?")) return false;' CommandArgument='<%# Eval("CodingType_Id") %>' CommandName="Del" runat="server">
